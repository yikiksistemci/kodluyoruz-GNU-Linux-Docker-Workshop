...
|Linux Dosya Yapısı|Linux dosya yapısı neleri barındır? Kim nerede ve kiminle dosça geçinir? Dosya yapısı hiyerarşisi
|Komut Satırında Bir Neil Armstrong|Linux'ta temel komutlar: "ls,cp,mv,touch,echo,cat,rm,rmdir,alias,tail,less,more,ln,pwd,uname,realpath,grep,find"|
|------------------|-----------------------|---|
|------------------|-----------------------|---|
|------------------|-----------------------|---|
|------------------|-----------------------|---|
